...
async function getHome() {
    ...
    if (category) {
        if (category == 'Electronics') {
            ...
            resp = await axios.get(server + "/home/sports");
        }
    }
    else {
